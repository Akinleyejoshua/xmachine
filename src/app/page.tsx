...
export default function WorkspacePage() {
  ...
  return (
    <main className="min-h-screen bg-white dark:bg-black text-neutral-900 dark:text-neutral-100 font-sans pb-16 transition-colors duration-200">
      ...
      {currentProject && (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8 pt-8 animate-in fade-in duration-500">
          
          {/* Header Dashboard */}
          <header className="flex items-center justify-between bg-neutral-50 dark:bg-neutral-900 rounded-xl px-6 py-5 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                <h1 className="font-extrabold text-sm tracking-wide text-neutral-900 dark:text-white font-mono uppercase">{currentProject.name}</h1>
